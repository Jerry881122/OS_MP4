...
// advance simulated time
    ...
    // if(stats->totalTicks<=100){
    //     cout << "\ttotalTicks = " << stats->totalTicks << endl;
    //     cout << "\tthread[" << kernel->currentThread->getID() << "]" << endl;
    //     cout << "\tStatus = " << kernel->currentThread->getStatus() << endl;
    //     cout << endl;
    // }
